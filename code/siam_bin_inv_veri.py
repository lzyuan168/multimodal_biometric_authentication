...
def main():
    ...
    wandb.init(
        ...
        name="siam_{}_run8(bin_inv_veri_fg)_BN_L2".format(MODEL_NAME),
        config={
            "learning_rate": LR,
            "epochs": N_EPOCHS,
            "batch":BATCH_SIZE,
    ...
    for epoch in range(1, N_EPOCHS+1):
        ...
        if val_accuracy >= best_val_acc:
            ...
            model_checkpoint_path = os.path.join(MODEL_CKPT, "{}{}_epoch_{}.pth".format(MODEL_NAME,"_siam_bin_inv_verification_fg", epoch))
